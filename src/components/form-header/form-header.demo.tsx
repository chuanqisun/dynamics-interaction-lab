    ...
    return (
      <StyledPage>
        ...
        <StyledSection className="prototype-notes">
          ...
          <ul>
            <li>
              Show form switcher only if there are multiple forms available. <button onClick={this.toggleFormSwitcher}>Toggle form switcher</button>
            </li>
            <li>
              Read-only badge is now a persistent banner message on top <button onClick={this.toggleShowReadOnlyMessage}>Toggle read-only message</button>
            </li>
            <li>Always show entity name as a small tag.</li>
            <li>
              Show large image only if record has its own unique image, e.g. Contacts. We will call it record image, instead of entity image.
              <button onClick={this.toggleRecordImage}>Toggle record image</button>
            </li>
            <li>
