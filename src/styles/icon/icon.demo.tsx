    ...
    return <React.Fragment>
      ...
      <section>
        ...
        <ul>
          ...
          <li>Import the icon constant <code>import {'{'}FullMDL2{'}'} from 'styles/icon/full-mdl2';</code></li>
          <li>Get the glyph from the constant in your html or jsx. In this demo, we use <input type="text" value={this.state.iconName} onChange={this.onHexChange} list="exampleList"></input></li>
