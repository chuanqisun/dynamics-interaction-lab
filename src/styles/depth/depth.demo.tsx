...
const reflectBoxShadow = (cssVar: string, e: any) =>
  e &&
  (e.innerHTML = `<span class="square" style="box-shadow: var(${cssVar})"></span><span>${getComputedStyle(document.body).getPropertyValue(cssVar)}</span>`);
