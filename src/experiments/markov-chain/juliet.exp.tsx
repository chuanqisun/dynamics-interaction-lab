...
import { FormHeader } from "./FormHeader/form-header";
import { GlobalNotification } from "./Notification/global-notification";
...
export class BusinessProcessExperiment extends React.Component<any, any> {
  ...
  constructor(props: any) {
    ...
    this.state = {
      ...
      stages: [{ name: "Qualify" }, { name: "Develop" }, { name: "Propose" }, { name: "Close" }],
          ...
          <Scrollbars className="page-center" autoHide autoHideTimeout={1000} autoHideDuration={200}>
            <div className="page-center-top">
              ...
              <div className="tabs-container">
                {formTabs.map((tab) => (
                  <button
                    onClick={() => this.setState({ selectedTabId: tab.id, userSelectedIndex: null })}
                    key={tab.id}
