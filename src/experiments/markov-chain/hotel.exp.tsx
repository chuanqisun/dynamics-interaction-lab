...
export class BusinessProcessExperiment extends React.Component<any, any> {
      ...
      <StyledApp>
        ...
        <div className="bottom">
          ...
          <Scrollbars className="page-right" autoHide autoHideTimeout={1000} autoHideDuration={200}>
            ...
            <BusinessProcessFlow
              className="business-process-flow"
              {...(businessProcessFlowProps as BusinessProcessFlowProps)}
              stages={[
                {
                  name: `Qualify ${this.state.recordAtIndex === 0 ? ` (active 5 days)` : ``}${
                    0 < this.state.recordAtIndex && this.state.userSelectedIndex === 0 ? ` (completed 3 min ago)` : ""
                  }`,
                  content: this.QualifyStage,
                },
                {
                  name: `Develop ${this.state.recordAtIndex === 1 ? ` (active 2 min)` : ``}${
                    1 < this.state.recordAtIndex && this.state.userSelectedIndex === 1 ? ` (completed 2 min ago)` : ""
                  }`,
                  content: this.DevelopStage,
                },
                {
                  name: `Propose ${this.state.recordAtIndex === 2 ? ` (active 2 min)` : ``}${
                    2 < this.state.recordAtIndex && this.state.userSelectedIndex === 2 ? ` (completed 1 min ago)` : ""
                  }`,
                  content: this.ProposeStage,
                },
                {
                  name: `Close ${this.state.recordAtIndex === 3 ? ` (active 1 min)` : ``}${
                    3 < this.state.recordAtIndex && this.state.userSelectedIndex === 3 ? ` (completed just now)` : ""
                  }`,
  ...
  QualifyStage: React.FunctionComponent<any> = () => (
    <form ref={this.qualifyStageFormRef} className="form-section form-section--borderless">
      <div className="ff">
  ...
  DevelopStage: React.FunctionComponent<any> = () => (
    <div className="form-section form-section--borderless">
      <div className="ff">
  ...
  ProposeStage: React.FunctionComponent<any> = () => (
    <div className="form-section form-section--borderless">
      <div className="ff">
  ...
  CloseStage: React.FunctionComponent<any> = () => (
    <div className="form-section form-section--borderless">
      <div className="ff">
